...
RUN elasticsearch-plugin install --batch https://artifacts.elastic.co/downloads/elasticsearch-plugins/repository-hdfs/repository-hdfs-6.4.2.zip
RUN elasticsearch-plugin install --batch file://$PWD/elasticsearch-analysis-ik-6.4.2.zip
